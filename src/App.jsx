                    ...
                    <div className="flex justify-between items-center gap-4">
                        <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-wrap">
                            <div className="flex items-center gap-2 min-w-0">
                                ...
                                <h3 className="text-lg font-bold text-white/90 truncate tracking-tight">{String(ev.cliente)}</h3>
                            </div>
                            <div className="flex items-center gap-2 shrink-0 mt-1 sm:mt-0">
                                {dateBadgeContent}
                                {ev.hora && (
                                    <span className="bg-blue-500/10 border border-blue-500/20 text-blue-400 px-2.5 py-1 rounded-[10px] text-[10px] sm:text-[11px] font-bold uppercase tracking-wider flex items-center gap-1.5 shadow-sm">
                                        <Clock size={12} strokeWidth={2.5}/> {utils.formatTime12h(ev.hora)}
                                    </span>
                                )}
                            </div>
                        </div>
